  ...
  useEffect(() => {
    const unsubAuth = onAuthStateChanged(auth, async (currentUser) => {
      ...
      if (currentUser) {
        ...
        if (userDoc.exists()) {
          setUsername(userDoc.data().name || userDoc.data().username || "Anonymous Faculty");
        }
      }
    });
      ...
      <div className="w-full max-w-6xl p-6">
        ...
        <div className="rounded-[2rem] border border-gray-800 bg-gradient-to-br from-gray-900 via-black to-gray-950 p-8 shadow-[0_0_40px_rgba(0,150,255,0.08)]">
          ...
          <p className="mt-4 text-gray-400">
            Faculty and students now post into an auto-categorised discussion stream for faster navigation.
          </p>
        </div>
